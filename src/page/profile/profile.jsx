...
const Profile = () => {
  ...
  const farmerData = {
    ...
    description: "Experienced coffee farmer with 10 years of sustainable farming practices. Specializing in arabica coffee cultivation at high altitudes.",
    contactInfo: {
      phone: "+250 78 123 4567",
      email: "josiane@example.com"
    },
    transactions: [
      { id: 1, date: "2025-02-15", product: "Coffee Beans (Grade A)", quantity: "500kg", buyer: "Kigali Coffee Exporters", status: "Completed" },
      { id: 2, date: "2025-01-20", product: "Maize", quantity: "1 ton", buyer: "Rwanda Grain Reserve", status: "Completed" },
      { id: 3, date: "2024-12-10", product: "Coffee Beans (Grade A)", quantity: "300kg", buyer: "Mountain Coffee Roasters", status: "Completed" }
    ],
    currentListings: [
      { id: 1, product: "Coffee Beans (Grade A)", quantity: "800kg", price: "RWF 2,400/kg", harvestDate: "March 2025" },
      { id: 2, product: "Beans", quantity: "500kg", price: "RWF 800/kg", harvestDate: "February 2025" }
    ]
  };
      ...
      case 'listings':
        return (
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <h3 className="text-lg font-semibold p-4 border-b">Current Listings</h3>
            {farmerData.currentListings.length > 0 ? (
              ...
              <p className="p-4 text-gray-500">No active listings at the moment.</p>
            )}
          </div>
        );
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {farmerData.transactions.map(transaction => (
                    <tr key={transaction.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">{transaction.product}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm">{transaction.quantity}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm">{transaction.buyer}</td>
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="bg-green-700 text-white p-6 rounded-t-lg">
        ...
        <p className="mt-1 text-green-100 text-sm">Transforming Agriculture in Rwanda</p>
      </div>
      ...
      <div className="bg-white p-6 shadow rounded-b-lg mb-6">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:ml-6">
            ...
            <p className="text-sm text-gray-500 mt-1">Member since {farmerData.memberSince}</p>
      ...
      <div className="mt-8 pt-6 border-t text-center text-sm text-gray-500">
        <p>AGRILINK Rwanda - Connecting farmers, cooperatives, and suppliers with buyers</p>
        <p className="mt-1">For a transparent and efficient agricultural marketplace.</p>
      </div>
    </div>
  );
};
