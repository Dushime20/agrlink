...
const MainContent = () => {
  ...
  <div className="bg-white flex gap-4 p-4 h-16 rounded-lg shadow-lg items-center justify-center">
    <div className='text-green-500 text-3xl'><FaShoppingCart/></div>
  <div>
  ...
  <div className='text-blue-500 text-3xl'><FaPerson/></div>
  <div>
  <h2 className="text-lg font-bold">Customer</h2>
  <p>100</p>
  </div>
  </div>
  <div className="bg-[#a9f1c6] p-4 h-16 rounded-lg shadow-lg text-center flex flex-col justify-center">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    <p className='text-green-500 text-2xl'><MdEdit/></p>
                       <p className='text-red-400 text-2xl'><MdDelete/></p>
                    </div>
                  </td>
                </tr>
                <tr>
