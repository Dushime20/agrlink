    ...
    <header className="  py-2 px-6 flex items-center justify-between w-full ">
      ...
      <div className="flex-grow mx-4 hidden md:flex">
        <input
          type="text"
          placeholder="Search..."
          className="w-full px-4 py-2 rounded-full bg-green-900 text-white focus:outline-none focus:ring-2 focus:ring-green-500"
        />
      </div>
      ...
      <div className="flex items-center space-x-4 ">
        {/* Notifications Icon */}
        <button className="relative p-2 rounded-full bg-green-900">
